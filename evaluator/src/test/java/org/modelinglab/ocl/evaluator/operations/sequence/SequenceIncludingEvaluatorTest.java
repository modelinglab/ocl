 ...
 */
public class SequenceIncludingEvaluatorTest extends AbstractBinaryOperationTest.AbstractCollectionBinaryOperationTest {
    
    public SequenceIncludingEvaluatorTest() {
    ...
    public void test() throws Exception {
        ...
        executeTest(inputVal, nullVal, TesterTool.evaluate("Sequence{1, 2.0, null}", null, false));
        executeTest(inputVal, presentElement, TesterTool.evaluate("Sequence{1, 2.0, 2.0}", null, false));
        executeTest(inputVal, notPresentElement, TesterTool.evaluate("Sequence{1, 2.0, -23.0}", null, false));
    }
}
