 ...
 */
public class RealSubstractionEvaluatorTest extends AbstractBinaryOperationTest.AbstractInfixOperationTest{
    
    public RealSubstractionEvaluatorTest() {
    ...
    public void test() throws Exception {
        ...
        executeTest(r0Val, r0Val, r0Val);
        executeTest(r0Val, r1Val, new RealValue(-r1));
        executeTest(r0Val, r2Val, new RealValue(-r2));
        executeTest(r0Val, i1Val, new RealValue((double) -i1));
        
        executeTest(r1Val, invalid, invalid);
        executeTest(r1Val, nullVal, invalid);
        executeTest(r1Val, r0Val, r1Val);
        executeTest(r1Val, r1Val, r0Val);
