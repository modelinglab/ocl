...
import org.modelinglab.ocl.core.ast.OperationsStore.OperationsStoreFactory;
...
public class TestEnvironment {
    ...
    public static StaticEnvironment createEnvironment() {
        ...
        OperationsStoreFactory factory = new OperationsStoreFactory();
        factory.addOperation(MyNumber.MyNumberLessOperation.INSTANCE);
        
        OperationsStore os = factory.createStore();
        ...
        variable = new Variable("person", null, person);
        env.addElement(variable, false);
        
        variable = new Variable("empoyee", null, employee);
        env.addElement(variable, false);
        
        variable = new Variable("employment", null, employment);
        env.addElement(variable, false);
        
        variable = new Variable("day", null, daysOfWeek);
        env.addElement(variable, false);
     
        env.addElement(MyNumber.INSTANCE);
