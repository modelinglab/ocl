...
import org.modelinglab.ocl.core.standard.operations.real.Multiplication;
 ...
 */
public class RealMultiplicationEvaluatorTest extends AbstractInfixOperationTest{
    
    public RealMultiplicationEvaluatorTest() {
        super(Multiplication.getInstance());
    }
    ...
    public void test() throws Exception {
        ...
        executeTest(i1Val, r0Val, r0Val);
        executeTest(i1Val, r1Val, new RealValue(r1 * i1));
        executeTest(i1Val, r2Val, new RealValue(r2 * i1));
//        executeTest(i1Val, i1Val, new IntegerValue(i1 * i1)); //TODO: This should fail. Integer operation should be executed
    }
}
