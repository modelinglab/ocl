 ...
 */
public class RealMaxEvaluatorTest extends AbstractBinaryOperationTest {
    
    public RealMaxEvaluatorTest() {
        super(Max.getInstance());
    }
    ...
    public void test() throws Exception {
        ...
        executeTest(r1Val, r2Val, new RealValue(Math.max(r1, r2)));
        executeTest(r1Val, i1Val, r1Val);

        executeTest(r2Val, invalid, invalid);
        executeTest(r2Val, nullVal, invalid);
        executeTest(r2Val, r1Val, new RealValue(Math.max(r1, r2)));
        executeTest(r2Val, r2Val, r2Val);
        executeTest(r2Val, i1Val, new IntegerValue(i1));
        
        executeTest(i1Val, invalid, invalid);
        executeTest(i1Val, nullVal, invalid);
        executeTest(i1Val, r1Val, r1Val);
        executeTest(i1Val, r2Val, i1Val);
        executeTest(i1Val, i1Val, new IntegerValue(i1)); //TODO: This should fail. Integer operation should be executed
    }
}
