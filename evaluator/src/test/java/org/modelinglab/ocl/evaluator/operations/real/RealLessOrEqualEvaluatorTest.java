 ...
 */
public class RealLessOrEqualEvaluatorTest extends AbstractBinaryOperationTest.AbstractInfixOperationTest{
    
    public RealLessOrEqualEvaluatorTest() {
    ...
    public void test() throws Exception {
        ...
        executeTest(r1Val, r2Val, falseVal);
        executeTest(r1Val, i1Val, falseVal);

        executeTest(r2Val, invalid, invalid);
        executeTest(r2Val, nullVal, invalid);
        executeTest(r2Val, r1Val, trueVal);
        executeTest(r2Val, r2Val, trueVal);
        executeTest(r2Val, i1Val, trueVal);
        
        executeTest(i1Val, invalid, invalid);
        executeTest(i1Val, nullVal, invalid);
        executeTest(i1Val, r1Val, trueVal);
        executeTest(i1Val, r2Val, falseVal);
