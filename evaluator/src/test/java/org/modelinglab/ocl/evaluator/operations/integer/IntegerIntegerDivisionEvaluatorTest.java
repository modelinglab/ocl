 ...
 */
public class IntegerIntegerDivisionEvaluatorTest  extends AbstractBinaryOperationTest {
    
    public IntegerIntegerDivisionEvaluatorTest() {
        super(IntegerDivision.getInstance());
    }
    ...
    public void test() throws Exception {
        ...
        executeTest(i0Val, i1Val, i0Val);
        executeTest(i0Val, i2Val, i0Val);
        
        executeTest(i1Val, invalid, invalid);
        executeTest(i1Val, nullVal, invalid);
        executeTest(i1Val, i0Val, invalid);
        executeTest(i1Val, i1Val, new IntegerValue(1l));
        ...
        executeTest(i2Val, i2Val, new IntegerValue(1l));
    }
}
