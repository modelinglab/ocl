 ...
 */
public class OclAnyOclIsKindOfEvaluatorTest extends AbstractBinaryOperationTest {

    public OclAnyOclIsKindOfEvaluatorTest() {
        super(new OclIsKindOf(OclIsKindOf.createTemplateOperation()));
    }
    ...
    public void test() throws Exception {
        ...
        executeTest(i1, realClassifier, trueVal);
        ...
        executeTest(nullVal, realClassifier, trueVal);
        executeTest(nullVal, intClassifier, trueVal);
