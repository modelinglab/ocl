 ...
 */
public class OrderedSetAppendEvaluatorTest  extends AbstractBinaryOperationTest.AbstractCollectionBinaryOperationTest {
    
    public OrderedSetAppendEvaluatorTest() {
    ...
    public void test() throws Exception {
        ...
        executeTest(inputVal, nullVal, TesterTool.evaluate("OrderedSet{1, 2, 2.0, 3, null}", null, false));
        executeTest(inputVal, presentElement, TesterTool.evaluate("OrderedSet{1, 2, 3, 2.0}", null, false));
        executeTest(inputVal, notPresentElement, TesterTool.evaluate("OrderedSet{1, 2, 2.0, 3, -23.0}", null, false));
