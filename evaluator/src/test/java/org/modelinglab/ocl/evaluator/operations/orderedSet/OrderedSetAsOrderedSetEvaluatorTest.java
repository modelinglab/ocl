 ...
 */
public class OrderedSetAsOrderedSetEvaluatorTest extends AbstractUnaryOperationTest.AbstractCollectionUnaryOperationTest {
    
    public OrderedSetAsOrderedSetEvaluatorTest() {
    ...
    public void test() throws Exception {
        OclValue<?> simpleOrderedSet = TesterTool.evaluate("OrderedSet{1,2, 3, 2}", null, false);
        ...
        executeTest(simpleOrderedSet, simpleOrderedSet);
    }
}
