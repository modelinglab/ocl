 ...
 */
public class IntegerMaxEvaluatorTest extends AbstractBinaryOperationTest {
    
    public IntegerMaxEvaluatorTest() {
    ...
    public void test() throws Exception {
        ...
        executeTest(i1Val, i2Val, new IntegerValue(Math.max(i1, i2)));

        executeTest(i2Val, invalid, invalid);
        executeTest(i2Val, nullVal, invalid);
        executeTest(i2Val, i1Val, new IntegerValue(Math.max(i1, i2)));
