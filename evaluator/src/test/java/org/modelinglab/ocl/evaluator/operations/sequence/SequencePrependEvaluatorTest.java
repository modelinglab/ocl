 ...
 */
public class SequencePrependEvaluatorTest extends AbstractBinaryOperationTest.AbstractCollectionBinaryOperationTest {
    
    public SequencePrependEvaluatorTest() {
    ...
    public void test() throws Exception {
        ...
        executeTest(inputVal, nullVal, TesterTool.evaluate("Sequence{null, 1, 2, 2.0, 3}", null, false));
        executeTest(inputVal, presentElement, TesterTool.evaluate("Sequence{2.0, 1, 2, 2.0, 3}", null, false));
        executeTest(inputVal, notPresentElement, TesterTool.evaluate("Sequence{-23.0, 1, 2, 2.0, 3}", null, false));
