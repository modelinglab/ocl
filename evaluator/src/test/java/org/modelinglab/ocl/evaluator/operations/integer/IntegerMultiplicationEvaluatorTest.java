 ...
 */
public class IntegerMultiplicationEvaluatorTest extends AbstractBinaryOperationTest.AbstractInfixOperationTest {
    
    public IntegerMultiplicationEvaluatorTest() {
