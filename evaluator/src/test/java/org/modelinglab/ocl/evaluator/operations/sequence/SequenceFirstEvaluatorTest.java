 ...
 */
public class SequenceFirstEvaluatorTest extends AbstractUnaryOperationTest.AbstractCollectionUnaryOperationTest{
    
    public SequenceFirstEvaluatorTest() {
    ...
    public void test() throws Exception {
        ...
        executeTest(TesterTool.evaluate("Sequence{1,2,3}", null, false), new IntegerValue(1l));
    }
}
