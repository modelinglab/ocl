...
import org.modelinglab.ocl.core.standard.operations.integer.Mod;
 ...
 */
public class IntegerModEvaluatorTest extends AbstractBinaryOperationTest {
    
    public IntegerModEvaluatorTest() {
        super(Mod.getInstance());
    }
