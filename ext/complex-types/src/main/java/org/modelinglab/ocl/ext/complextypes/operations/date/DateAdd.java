 ...
 */
public class DateAdd extends Operation {
    ...
    private DateAdd() {
        ...
        Parameter term = new Parameter();
        term.setName("toAdd");
        term.setType(PrimitiveType.getInstance(PrimitiveType.PrimitiveKind.INTEGER));
        addOwnedParameter(term);
    ...
    @Override
    public Operation specificOperation(Classifier sourceType, java.util.List<Classifier> argTypes,
            TemplateRestrictions restrictions) {
        return this;
    }

    public static DateAdd getInstance() {
        return INSTANCE;
    }
