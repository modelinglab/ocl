...
import org.modelinglab.ocl.ext.complextypes.operations.string.StringEndsWith;

/**
 *
 */
public class StringEndsWithEvaluator extends OperationEvaluator {
    ...
    public OclValue<?> visit(StringValue val, OperationEvaluator.SwitchArgument arg) {
        ...
        return BooleanValue.createValue(val.getValue().endsWith(subString.getValue()));
    }

    @Override
    public Operation getEvaluableOperation() {
        return StringEndsWith.getInstance();
    }
