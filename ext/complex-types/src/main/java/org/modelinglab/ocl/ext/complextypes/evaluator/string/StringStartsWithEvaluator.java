...
import org.modelinglab.ocl.ext.complextypes.operations.string.StringStartsWith;

/**
 *
 */
public class StringStartsWithEvaluator extends OperationEvaluator {
    ...
    public OclValue<?> visit(StringValue val, OperationEvaluator.SwitchArgument arg) {
        ...
        return BooleanValue.createValue(val.getValue().startsWith(subString.getValue()));
    }

    @Override
    public Operation getEvaluableOperation() {
        return StringStartsWith.getInstance();
    }
