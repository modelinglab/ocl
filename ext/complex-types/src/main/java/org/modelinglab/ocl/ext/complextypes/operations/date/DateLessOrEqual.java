 ...
 */
@Immutable
public class DateLessOrEqual extends Operation {
    private static final long serialVersionUID = 1L;
    private static final DateLessOrEqual INSTANCE = new DateLessOrEqual();
    ...
    public static DateLessOrEqual getInstance() {
        return INSTANCE;
    }
